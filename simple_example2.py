...
output_settings = {	'type':'IAGL', #Dat type to output.  This is currently the only option.  ARGDB will be added later
					'output_filename':'Arcade_3_Game_Example.xml', #Filename to output
					'header_name': 'Arcade Games Example', #IAGL header will be populated with this
...
dat_info = [
	{'type': 'OVGDB','filename':'OpenVGDB 28.0.sqlite','platform':['Arcade'],'save_conversion':True}, #1, OVGDB, save converted file to json
	]
